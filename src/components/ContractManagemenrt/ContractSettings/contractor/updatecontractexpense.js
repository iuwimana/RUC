...
export const Updatecontractexpense = ({ 
    contractid,
    expensecontractid,
    expensetypename,
    expensetypeid,
  ...
  //----------------------Initialize serviceorder data---------------------------------
    ...
    const [Expensetypename,setexpensetypename]= useState(expensetypename);
    const [Expensetypeid,setexpensetypeid]= useState(expensetypeid);    
