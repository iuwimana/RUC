...
class Modal extends Component {
  ...
  handleClick = async (e) => {
    try {
      ...
      {
        toast.error(
          "Amount you pay is greater than contract amount"
        );
      }else{
        await Contractpayment.addcontractpayment(contractpaymentid,data.contractid,data.payedamount,data.contractbudget,remainamount)
