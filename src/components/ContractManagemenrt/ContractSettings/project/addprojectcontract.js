...
const [enddate, setenddate] = useState("");
  ...
  //-------------------------
    ...
    try {
      const contractprojectid=0;
      const contractid=0;
      await Projectcontractdate.addcontractproject(contractprojectid,props.projectid,contractid,contractorid,startdate,enddate, props.contracttypeid,
	          contractdiscription,props.roodid,props.maintenancetypeidid,budget,activitysourceoffundid)
      toast.success(`
