  ...
  async handleSave(e) {
    try {
      ...
      if (this.state.status === "New") {
        ...
        await ServiceOrderData.rejectserviceorder(this.state.serviceorderid, statuse);
      ...
      toast.success(`Rejection has initiated successfull ${this.state.serviceorderid}`);
