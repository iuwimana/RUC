...
class Modal extends Component {
  ...
  async componentWillReceiveProps(nextProps) {
    this.setState({
      ...
      serviceorderamount: nextProps.serviceorderamount,
    });
  }
                    ...
                    <Card className=" shadow border-0">
                      ...
                      <CardBody className="px-lg-5 py-lg-5">
                        <div className="row">
                          ...
                          <div className="col">
                            <b>Service Order description</b>
                          </div>
                          <div className="col">
                            {this.state.serviceorderdescription}
                          </div>
                        </div>
                        <div className="row">
                          <div className="col">
                            <b>Service Order Contract type</b>
                          </div>
                          <div className="col">
                        ...
                        <div className="row">
                          ...
                          <div className="col">{this.state.damagedlevel}</div>
                        </div>
                        <div className="row">
                          <div className="col">
                            <b>Service Order Budget</b>
                          </div>
                          <div className="col">{this.state.serviceorderamount}</div>
                        </div>
                        <div className="row">
                          <div className="col">
                            <label>
                          ...
                          <div className="col">
                            <label>{this.state.contractorstartdate}</label>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col">
                        ...
                        <div className="row">
                          ...
                          <div className="col">{this.state.serviceorderstatus}</div>
                        </div>
                      </CardBody>
                    </Card>
                  </div>
                    ...
                    <Card className=" shadow border-0">
                      ...
                      <CardBody className="px-lg-5 py-lg-5">
                        ...
                        <div className="row">
                          ...
                          <div className="col">
                            From:{this.state.startquarter} To:
